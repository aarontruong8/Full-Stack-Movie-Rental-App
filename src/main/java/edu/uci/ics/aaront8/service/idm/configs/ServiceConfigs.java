package edu.uci.ics.aaront8.service.idm.configs;
...
public class ServiceConfigs {
    ...
    public ServiceConfigs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if (dbDriver == null){
                System.err.println("No driver found in config file.");
                dbConfigValid = false;
            } else {
            ...
            if (dbSettings == null){
                System.err.println("No connection settings found in config file.");
                dbConfigValid = false;
            } else {
            ...
            if (timeout < 0){
                ...
                System.err.println("Invalid timeout found in config file. Using default");
            ...
            if (expiration < 0){
                System.err.println("Invalid expiration found in config file. Using default");
