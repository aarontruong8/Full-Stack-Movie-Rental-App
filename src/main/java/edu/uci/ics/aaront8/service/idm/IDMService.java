package edu.uci.ics.aaront8.service.idm;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.aaront8.service.idm.configs.ConfigsModel;
...
public class IDMService {
    ...
    public static final String RESOURCE_PATH = "edu.uci.ics.aaront8.service.idm.resources";
    ...
    public static long TimeOut() {
        return serviceConfigs.getTimeout();
    }
    public static long Expired() { return serviceConfigs.getExpiration();}
}